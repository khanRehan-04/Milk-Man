...
namespace FirstPersonMobileTools.DynamicFirstPerson
{
    public class CameraLook : MonoBehaviour
    {
        ...
        private bool IsTouchInLookZone(Touch touch)
        {
            // Only allow touches in the right 60% of the screen (landscape mode)
            return touch.position.x >= Screen.width * 0.4f;
        }
